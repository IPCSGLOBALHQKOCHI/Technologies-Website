...
const Footer = () => {
  return (
    <footer className=" py-16 px-14 h-[75vh]">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 text-left">
        <div>
          <img
            src={Logo}
            alt="IPCS Technologies Logo"
            className="mb-4 w-40 h-20"
          />
          <div className="font-300 text-xl leading-loose tracking-[0.5px] ml-4 text-[#FFFFFF99]">
        ...
        <div>
          ...
          <button className="bg-[#25789B] text-[#FFFFFF] px-6 py-2 mt-7 rounded-md">
            Connect Us
          </button>
        </div>
      </div>
      <div className="border-t border-gray-700 mt-20 pt-6 text-[#FFFFFF] text-center text-md font-300">
