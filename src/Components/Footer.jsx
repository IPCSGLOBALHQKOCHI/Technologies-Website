...
const Footer = () => {
  return (
    <footer className="pt-10 sm:pt-16 px-4 sm:px-8 md:px-14 xl:px-24 h-auto bg-[radial-gradient(50%_30%_at_30%_50%,#010741_-30%,rgba(2,6,52,0)_100%)] backdrop-blur-5xl">
      {/* Top Section */}
      ...
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-4 md:gap-4 text-center sm:text-left">
        ...
        <div className="px-4 w-full sm:w-80 lg:w-72 text-center sm:text-left">
          <h3 className="mt-3 mb-4 sm:mb-6 text-[#FFFFFF] text-xl sm:text-2xl font-500 tracking-[0.40px]">
            Connect Us
          </h3>
          <ul className="leading-[40px] sm:leading-[45px] text-lg sm:text-xl font-300 text-[#FFFFFF99]">
            ...
            <li className="flex justify-center sm:justify-start space-x-4 mt-4">
              <a
      ...
      <div className="border-t border-[#3A3A3A] mt-5 sm:mt-6 pt-4 sm:pt-6 mb-4 text-[#FFFFFF] text-center text-sm sm:text-lg font-200 leading-normal">
        <div className="flex flex-wrap justify-center items-center gap-2">
          <p>
            © 2025 &nbsp; IPCS Technologies &nbsp; All Rights Reserved
            &nbsp;|&nbsp;
          </p>
