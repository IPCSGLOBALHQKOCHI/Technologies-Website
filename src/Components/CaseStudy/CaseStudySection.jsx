...
const CaseStudySection = forwardRef((props, ref) => {
  ...
  {/* Card 1 */}
  <div className="hidden md:block col-span-1 md:col-span-2 bg-[#0B0B0B] p-6 rounded-3xl flex-col justify-center h-64 hover:shadow-[0px_0px_20px_5px_rgba(0,169,255,0.3)]">
  ...
  {/* Card 2 */}
  <div className="col-span-1 bg-[#0B0B0B] p-6 rounded-3xl flex flex-col h-64 hover:shadow-[0px_0px_20px_5px_rgba(0,169,255,0.3)]">
    <h2 className="text-2xl font-500 text-[#FDDA21] text-center">Branding</h2>
    <img src={sisuLogo} alt="sisu logo" />
  ...
  {/* Card 3 */}
  <div className="col-span-1 bg-[#0B0B0B] p-6 rounded-3xl flex flex-col justify-center h-64 hover:shadow-[0px_0px_20px_5px_rgba(0,169,255,0.3)] bg-[radial-gradient(circle_at_0%_top,rgba(41,51,39,0.6)_0%,transparent_100%)]">
    <h2 className="text-xl font-500 text-[#A1FFAC] text-center">Landing Page</h2>
    <img src={makayiramLogo} alt="makayiram logo" />
    <p className="text-[#DEDCB2] text-center font-500">UI/UX Design</p>
  </div>

  {/* Card 4 */}
  <div className="col-span-1 bg-[#0B0B0B] p-4 pt-6 rounded-3xl h-64 hover:shadow-[0px_0px_20px_5px_rgba(0,169,255,0.3)]">
    <h2 className="text-3xl text-center font-500 text-[#FFFFFFCC]">Tools We Use</h2>
  ...
  {/* Card 5 */}
  <div className="col-span-1 rounded-3xl h-52 p-1 flex items-center justify-center">
    <img src={image1} alt="bentoimage" className="w-full h-full object-cover rounded-2xl" />
  </div>

  {/* Card 6 */}
  <div className=" hidden  md:block col-span-1 md:col-span-2 bg-[#0B0B0B] mr-0 md:mr-[13%] p-6 pt-2 rounded-3xl flex-col space-x-4 h-52 hover:shadow-[0px_0px_20px_5px_rgba(0,169,255,0.3)]">
    <div className="flex justify-between w-full">
      <div className="max-w-[50%]">
        <p className="text-[#9999FF] text-[12px]">Before (Feb 2024)</p>
        <p className="text-[#FFFFFF] text-[10px]">Zero Organic reach, no Google Ranking!</p>
      </div>
      <div className="max-w-[50%] text-left">
        <p className="text-[#B659FF] text-[12px]">After (Nov 2024)</p>
        <p className="text-[#FFFFFF] text-[10px]">
          In 8 months, Organic reach multiplied and keyword rankings skyrocketed to the Top 10 on Google!
        </p>
      </div>
    </div>
    <div className="flex items-center justify-center space-x-4">
      <img src={lowGraph} alt="Low Graph" className="w-20 h-auto object-contain mt-12" />
      ...
      <img src={highGraph} alt="High Graph" className="w-20 h-auto object-contain -mt-2" />
    </div>
  ...
  {/* Card 7 */}
  <div className="col-span-1 md:col-span-1 bg-[#0B0B0B] -ml-0 md:-ml-[26%] p-6 pt-10 rounded-3xl flex flex-col h-52 hover:shadow-[0px_0px_20px_5px_rgba(0,169,255,0.3)]">
    <h2 className="text-xl font-400 text-[#FFF]">
      Client: <span className="text-xl text-[#FFFFFF] font-500">MAKAYIRAM</span>
    </h2>
  ...
  {/* Card 8 */}
  <div className="col-span-1 flex flex-col h-52 space-y-4">
  ...
  {/* Card 9 */}
  <div className="col-span-1 md:col-span-2 bg-[#0B0B0B] p-6 rounded-3xl h-56 hover:shadow-[0px_0px_20px_5px_rgba(0,169,255,0.3)]">
    <div className="border-[1px] border-[#B659FF] rounded-full text-center justify-center mx-8">
      <h2 className="text-3xl font-200 text-center py-3 text-[#FFFFFF]">16-Year Legacy</h2>
    </div>
  ...
  {/* Card 10 */}
  <div className="col-span-1 md:col-span-1 bg-[#0B0B0B] -mr-0 md:-mr-[25%] text-white p-4 rounded-3xl flex flex-col hover:shadow-[0px_0px_20px_5px_rgba(0,169,255,0.3)]">
    <h2
  ...
  {/* Card 11 */}
  <div className="col-span-1 md:col-span-1 bg-[#0B0B0B] ml-0 md:ml-[25%] p-6 rounded-3xl flex flex-col justify-center hover:shadow-[0px_0px_20px_5px_rgba(0,169,255,0.3)]">
    <img src={globalLogo} alt="global logo" />
  </div>

  {/* Card 12 */}
  <div className="col-span-1 rounded-3xl flex flex-col justify-center">
