...
function ProcessDM() {
  return (
    <>
      <h1 className="px-6 md:px-10 lg:px-20 text-3xl lg:text-6xl pb-2 font-400 bg-gradient-to-r from-[#001BCB] to-[#FE55D9] animate-gradient-fill bg-clip-text text-transparent">
