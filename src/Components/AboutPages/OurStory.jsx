...
function OurStory() {
  ...
  return (
    <div className="h-auto px-4 sm:px-8 md:px-16 lg:px-24 py-12 md:py-16 ">
      <h1 className="font-300 text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-[#FFFFFFCC] text-left">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-2 sm:px-0 py-8">
        <div className="p-6 sm:p-8 text-left" ref={years.ref}>
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-200 text-center text-[#ffffff]">
            {years.count}+
          </h1>
